...
class NovusXpath(NovusSelector):
    ...
    partial_url_product_list: str = "//a[@class='base-is-link base-card catalog-products__item']/@href"
    product: Product = Product(name="//h1[@class='product-card__label h3']/text()",
                               product_url=None,
                               image_url=
                               "//div[@class='base-slider product-card__slider']"
                               "//img[@class='base-image__img']/@src",
                               price=PriceXpath(
                                   selector_xpath="//p[@class='product-card__price-current h4 product-"
                                                  "card__price-current_red']/text()",
                                   alternative_xpath="//p[@class='product-card__price-current h4']/text()"),
                               # {'selector_xpath':
